                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="mt-1 text-gray-900">{user?.name || 'No name provided'}</div>
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-500">Email Address</label>
                      <div className="mt-1 text-gray-900">{user?.email || 'No email provided'}</div>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="mt-1 text-gray-900">{user?._id || 'N/A'}</div>
                    </div>
                  </div>
                </div>
              </div>
